...
/*   Updated: 2026/05/09 20:40:30 by cebouhad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void ft_toupper_test(int c, int *r)
{
        if(ft_toupper(c) != toupper(c))
        {
            printf("ft_toupper error with input %d ->"TEST_NOK"\n", c);
            *r = 0;
        }
}
